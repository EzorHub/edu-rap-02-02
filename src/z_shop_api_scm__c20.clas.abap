...
"! <em>cds_zsd_shop__c20</em>
CLASS z_shop_api_scm__c20 DEFINITION
  PUBLIC
...
CLASS z_shop_api_scm__c20 IMPLEMENTATION.

  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_shop__c20' ) ##NO_TEXT.
